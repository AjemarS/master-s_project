...
export default function HomePage() {
  return (
    <>
      <main
        className={`
          flex min-h-screen flex-col gap-y-16 bg-linear-to-b from-muted/50
              ...
              <div className="flex flex-col justify-center space-y-6">
                <div className="space-y-4">
                  ...
                  <p
                    ...
                    `}
                  >
                    Discover premium products at competitive prices, with fast shipping and
            ...
            >
              ...
              <div className="relative z-10 mx-auto max-w-2xl text-center">
                ...
                <p
                  ...
                  `}
                >
                  Join thousands of satisfied customers and experience the best tech products on the
                  market. Sign up today for exclusive deals and offers.
                </p>
                <div
                  className={`
