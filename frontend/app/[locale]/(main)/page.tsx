  ...
  return (
    <main className="flex min-h-screen flex-col gap-y-16 bg-linear-to-b from-muted/50 via-muted/25 to-background">
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-col items-center text-center">
            <h2 className="font-display text-3xl leading-tight font-bold tracking-tight md:text-4xl">{t("categoriesTitle")}</h2>
      ...
      <section className="py-12 md:py-16" id="features">
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-col items-center text-center">
            <h2 className="font-display text-3xl leading-tight font-bold tracking-tight md:text-4xl">{t("featuresTitle")}</h2>
            <div className="mt-2 h-1 w-12 rounded-full bg-primary" />
          ...
          <div className="relative overflow-hidden rounded-xl bg-primary/10 p-8 shadow-lg md:p-12">
            ...
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              ...
              <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
                <Link href="/sign-up">
                  <Button className="h-12 px-8 transition-colors duration-200" size="lg">{t("ctaSignUp")}</Button>
                </Link>
                <Link href="/products">
                  <Button className="h-12 px-8 transition-colors duration-200" size="lg" variant="outline">{t("ctaCatalog")}</Button>
                </Link>
              </div>
            </div>
          </div>
