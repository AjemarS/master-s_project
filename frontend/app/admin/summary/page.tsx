...
export default function SummaryPage() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        // Fetch products stats from Django via API client
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-8 flex items-center justify-center">
