...
export default function SummaryPage() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        // Fetch users stats from better-auth
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Dashboard Summary</h1>
          <p className="text-slate-600">Overview of your system statistics</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                <div>
                  <div className="font-medium text-slate-900">Active Users</div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                <div>
                  <div className="font-medium text-slate-900">Low Stock Items</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-medium text-slate-900">Auth Service</div>
                    <div className="text-sm text-slate-500">http://localhost/auth</div>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                <div className="flex items-center gap-3">
                  <div className="h-3 w-3 bg-green-500 rounded-full animate-pulse"></div>
                  <div>
                    <div className="font-medium text-slate-900">Product Service</div>
                    <div className="text-sm text-slate-500">http://localhost/api</div>
                  </div>
                </div>
                <Badge variant="default">Online</Badge>
              </div>
